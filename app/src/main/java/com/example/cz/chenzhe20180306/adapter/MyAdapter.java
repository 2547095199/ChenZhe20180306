...
import com.example.cz.chenzhe20180306.persenter.DeletePersenter;
import com.example.cz.chenzhe20180306.persenter.UpDatePersenter;
import com.example.cz.chenzhe20180306.view.CustCrom;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> implements DeleteView, UpDateView {
    Context context;
...
//        holder.content.setEditText(list.get(position).getNum());
        ...
        holder.itemDel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                persenter.getData("101", list.get(position).getPid() + "", "android");
                //list删除数据
        ...
        holder.cust.setListener(new CustCrom.ClickListener() {
            ...
            public void click(int count) {
                upDatePersenter.getDate("101", list.get(position).getSellerid() + "", list.get(position).getPid() + "", list.get(position).getSelected() + "", count + "");
